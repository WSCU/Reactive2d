...
gp1 = p2(-cos(-localTime)*25, -sin(-localTime)*25)
gp2 = p2(cos(-localTime)*25, sin(-localTime)*25)
...
square(p2(100,100), size = 50, skew = 0.5, zLayer = 3, color = black, rotation = (localTime), useGrad = True, gradp1 = p2(-25,0), gradp2 = p2(25,0), gradc1 = red, gradc2 = blue)
...
circle(p2(30, 100), size = 50, skew = 0.5, zLayer = 3, color = black, rotation = 0, useGrad = True, gradp1 = gp1, gradp2 = gp2, gradc1 = red, gradc2 = blue)
